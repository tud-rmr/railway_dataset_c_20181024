...
gnss_thales_processed_data_paths = { ... 
                                     fullfile('gnss_thales_processed_data_session01.csv'); ... 
                                     fullfile('gnss_thales_processed_data_session02.csv'); ... 
                                     fullfile('gnss_thales_processed_data_session03.csv')  ... 
                                   };
...
imu_inatm200stn_processed_data_paths = { ... 
                                         ...
                                         fullfile('imu_inatm200stn_processed_data_session02.csv'); ...
...
[out_data, num_files, load_flag] = importFromFile(gnss_thales_processed_data_paths,gnss_thales_processed_data_root_string,'DataType','processed');
for i = find(load_flag(:)'==1) % save to .mat for faster access in the future
    exportToFile(out_data(i,:),[gnss_thales_processed_data_root_string,'_session',sprintf('%02i',i)],gnss_thales_processed_data_root_string,'SaveTo','mat','NumFiles',num_files(i));
end % for i
