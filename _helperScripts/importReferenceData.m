...
%                                fullfile('ref_inatm200stn_internal_ekf_data_session01_part01.csv'); ... 
%                                fullfile('ref_inatm200stn_internal_ekf_data_session01_part02.csv'); ... 
%                                fullfile('ref_inatm200stn_internal_ekf_data_session01_part03.csv'); ... 
%                                fullfile('ref_inatm200stn_internal_ekf_data_session01_part04.csv'); ...
%                                fullfile('ref_inatm200stn_internal_ekf_data_session01_part05.csv'); ...
%                                %
%                                fullfile('ref_inatm200stn_internal_ekf_data_session02_part01.csv'); ... 
%                                fullfile('ref_inatm200stn_internal_ekf_data_session02_part02.csv'); ... 
%                                fullfile('ref_inatm200stn_internal_ekf_data_session02_part03.csv'); ... 
%                                %
%                                fullfile('ref_inatm200stn_internal_ekf_data_session03_part01.csv'); ... 
%                                fullfile('ref_inatm200stn_internal_ekf_data_session03_part02.csv'); ... 
%                                fullfile('ref_inatm200stn_internal_ekf_data_session03_part03.csv'); ... 
%                                fullfile('ref_inatm200stn_internal_ekf_data_session03_part04.csv'); ... 
%                                fullfile('ref_inatm200stn_internal_ekf_data_session03_part05.csv'); ... 
%                                fullfile('ref_inatm200stn_internal_ekf_data_session03_part06.csv'); ... 
%                                fullfile('ref_inatm200stn_internal_ekf_data_session03_part07.csv'); ... 
%                                fullfile('ref_inatm200stn_internal_ekf_data_session03_part08.csv'); ... 
%                                fullfile('ref_inatm200stn_internal_ekf_data_session03_part09.csv'); ... 
%                                fullfile('ref_inatm200stn_internal_ekf_data_session03_part10.csv'); ... 
%                                fullfile('ref_inatm200stn_internal_ekf_data_session03_part11.csv'); ... 
%                                fullfile('ref_inatm200stn_internal_ekf_data_session03_part12.csv'); ... 
%                                fullfile('ref_inatm200stn_internal_ekf_data_session03_part13.csv'); ... 
%                                fullfile('ref_inatm200stn_internal_ekf_data_session03_part14.csv') ...                               
%                              };
